...
export default function SeekerAuthScreen({ onLogin, onBack }: Props) {
    ...
    const handleSubmit = () => {
        const displayName = isLogin ? (name || email || 'Seeker') : (name || 'Seeker');
        onLogin(displayName, email || 'seeker@submatch.com');
    };
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        <Text style={styles.title}>Room Seeker</Text>
                        <Text style={styles.subtitle}>
                            {isLogin ? 'Welcome back! Sign in to continue' : 'Create an account to find rooms'}
                        </Text>
